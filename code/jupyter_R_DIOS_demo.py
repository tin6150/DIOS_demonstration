...
# 
# - cd2e953 - restored to orig sim param 100/30//1000 for benchmark timing vs jupyter_R_DIOS_demo_par.ipynb - 2020.0927
# 
# ################################################################
# 
# version on bfh, 
...
## consider parallelizing the 3 chain* SimAnneal calls...
...
chain1 <- SimAnneal(existing.sites = coord.sampled, 
...
print("\n")
print('## **==** finished chain1 of SimAnneal ### ch1 ###')
system('date; uptime; hostname', intern=TRUE)
print(system('cat /proc/loadavg', intern=TRUE))
...
##~~ may tmp disable repeat of simulated annealing to speed up prototyping.
...
print("\n")
print('## **==** finished chain2 of SimAnneal ### ch2 ###')
system('date; uptime; hostname', intern=TRUE)
print(system('cat /proc/loadavg', intern=TRUE))
...
print("\n")
print('## **==** finished chain3 of SimAnneal ### ch3 ###')
system('date; uptime; hostname', intern=TRUE)
print(system('cat /proc/loadavg', intern=TRUE))
...
##-- SA1 <- rbind(chain1, chain1, chain1)      ## tmp just use result of one simulation.
