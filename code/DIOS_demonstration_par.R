...
## rest of this code not changed yet. 2020.0927
...
chain1 <- mcparallel( SimAnneal(existing.sites = coord.sampled, alt.sites = coord.unsampled, n.choose = 3, rho = "logYValue0.3", disease.d.set = krige0.3.sim@data, obj.fun = OBJ1, initial.ml = initial.ml.3, neigh.fun = neigh.fun, T0 = 0.075, alpha = 0.9987, T.thres = 1e-6) )
...
##
print("check for warnings, just in case")
print(warnings())
print(system('date; uptime; hostname', intern=TRUE))  
